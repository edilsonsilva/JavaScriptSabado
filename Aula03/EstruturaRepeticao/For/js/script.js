...
function for2(){
    ...
    for(var p = 1 ; p <= 10 ; p++){
        ...
        //Exibir o resultado em na página html. Vamos usar uma div como base.
...
function for3(){
    ...
    //Vamos fazer uma referência a tag body para criar 
    //novos elementos html dentro dela
    var body = document.body;
    
    // vamos construir uma tag h1 e adicioná-la ao body
